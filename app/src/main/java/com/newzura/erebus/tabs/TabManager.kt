package com.newzura.erebus.tabs
...
import com.newzura.erebus.ui.adapters.TabAdapter
import com.newzura.erebus.web.BrowserCallbacks
import com.newzura.erebus.web.configureWebView
...
data class BrowserTab(
    ...
    val speechBridge: com.newzura.erebus.web.SpeechRecognitionBridge,
...
class TabManager(
    ...
    fun createBrowserTab(initialUrl: String?, initialTitle: String = "", activate: Boolean): BrowserTab? {
        ...
        val speechBridge = com.newzura.erebus.web.SpeechRecognitionBridge(tabView) { pageUrl ->
    ...
    private fun setupWebMessageListener(webView: android.webkit.WebView, speechBridge: com.newzura.erebus.web.SpeechRecognitionBridge) {
        if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
            WebViewCompat.addWebMessageListener(webView, com.newzura.erebus.web.SpeechRecognitionBridge.BRIDGE_OBJECT_NAME, setOf("*")) { webViewInstance, message, sourceOrigin, isMainFrame, _ ->
