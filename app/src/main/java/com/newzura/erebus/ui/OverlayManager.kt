...
import com.newzura.erebus.settings.SettingsCallbacks
import com.newzura.erebus.settings.SettingsViews
import com.newzura.erebus.startpage.StartPageManager
import com.newzura.erebus.tabs.TabManager
import com.newzura.erebus.web.updatePageDarkening
...
class OverlayManager(
    ...
    fun showCheckLatestView() {
        ...
        binding.checkLatestInstalledVersion.text = activity.getString(
            ...
            "v${com.newzura.erebus.BuildConfig.VERSION_NAME}"
        )
            ...
            try {
                ...
                if (conn.responseCode == 200) {
                    ...
                    activity.runOnUiThread {
                        ...
                        val currentVer = com.newzura.erebus.BuildConfig.VERSION_NAME.trim().removePrefix("v")
