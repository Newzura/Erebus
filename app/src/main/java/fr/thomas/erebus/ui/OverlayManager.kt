...
import fr.thomas.erebus.settings.SettingsCallbacks
import fr.thomas.erebus.settings.SettingsViews
import fr.thomas.erebus.startpage.StartPageManager
import fr.thomas.erebus.tabs.TabManager
import fr.thomas.erebus.web.updatePageDarkening
...
class OverlayManager(
    ...
    fun showCheckLatestView() {
        ...
        binding.checkLatestInstalledVersion.text = activity.getString(
            ...
            "v${fr.thomas.erebus.BuildConfig.VERSION_NAME}"
        )
    ...
    private fun fetchLatestVersion() {
        Thread {
            try {
                val url = java.net.URL("https://api.github.com/repos/thomas/Erebus/releases/latest")
                ...
                if (conn.responseCode == 200) {
                    ...
                    activity.runOnUiThread {
                        ...
                        val currentVer = fr.thomas.erebus.BuildConfig.VERSION_NAME.trim().removePrefix("v")
