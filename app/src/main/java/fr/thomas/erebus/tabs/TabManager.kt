...
import fr.thomas.erebus.ui.adapters.TabAdapter
import fr.thomas.erebus.web.BrowserCallbacks
import fr.thomas.erebus.web.configureWebView
...
data class BrowserTab(
    ...
    val speechBridge: fr.thomas.erebus.web.SpeechRecognitionBridge,
...
class TabManager(
    ...
    fun createBrowserTab(initialUrl: String?, initialTitle: String = "", activate: Boolean): BrowserTab? {
        ...
        val speechBridge = fr.thomas.erebus.web.SpeechRecognitionBridge(tabView) { pageUrl ->
    ...
    private fun setupWebMessageListener(webView: android.webkit.WebView, speechBridge: fr.thomas.erebus.web.SpeechRecognitionBridge) {
        if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
            WebViewCompat.addWebMessageListener(webView, fr.thomas.erebus.web.SpeechRecognitionBridge.BRIDGE_OBJECT_NAME, setOf("*")) { webViewInstance, message, sourceOrigin, isMainFrame, _ ->
