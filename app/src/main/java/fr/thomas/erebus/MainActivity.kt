...
import fr.thomas.erebus.AppConstants.FREE_DROID_WARN_SOLUTIONS_URL
import fr.thomas.erebus.AppConstants.FREE_DROID_WARN_VERSION_KEY
import fr.thomas.erebus.AppConstants.GITHUB_REPO_URL
import fr.thomas.erebus.AppConstants.KEEP_ANDROID_OPEN_URL
import fr.thomas.erebus.AppConstants.MENU_BUTTON_AUTO_HIDE_DELAY_MS
import fr.thomas.erebus.AppConstants.MENU_BUTTON_SHOW_DELAY_MS
import fr.thomas.erebus.AppConstants.REQUEST_CODE_POST_NOTIFICATIONS
import fr.thomas.erebus.AppConstants.REQUEST_CODE_RECORD_AUDIO
import fr.thomas.erebus.bookmarks.BookmarkManager
import fr.thomas.erebus.data.BrowserPreferences
import fr.thomas.erebus.data.SiteIconCache
import fr.thomas.erebus.databinding.ActivityMainBinding
import fr.thomas.erebus.model.QuickActionButtonMode
import fr.thomas.erebus.model.UserAgentProfile
import fr.thomas.erebus.navigation.NavigationManager
import fr.thomas.erebus.permissions.PermissionManager
import fr.thomas.erebus.startpage.StartPageManager
import fr.thomas.erebus.tabs.BrowserTab
import fr.thomas.erebus.tabs.TabManager
import fr.thomas.erebus.ui.BrowserUIManager
import fr.thomas.erebus.ui.MainActivitySetup
import fr.thomas.erebus.ui.OverlayManager
import fr.thomas.erebus.ui.ThemeManager
import fr.thomas.erebus.web.BrowserCallbacks
import fr.thomas.erebus.web.releaseCompletely
import fr.thomas.erebus.web.updateDesktopMode
import fr.thomas.erebus.web.updateUserAgentProfile

/**
 * MainActivity serves as the central hub for the Erebus application.
...
class MainActivity : AppCompatActivity() {
    ...
    var latestReleaseUrl: String = "https://github.com/kododake/Erebus/releases"
        private set
