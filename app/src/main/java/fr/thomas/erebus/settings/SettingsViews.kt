package fr.thomas.erebus.settings
...
import fr.thomas.erebus.model.AppThemeMode
import fr.thomas.erebus.model.QuickActionButtonMode
import fr.thomas.erebus.model.QuickActionButtonPosition
...
object SettingsViews {
    fun createSettingsContent(
        ...
        sponsorsQrImage.setImageBitmap(fr.thomas.erebus.ui.QRUtils.generateQrCode(sponsorUrl, dp(100)))
        ...
        clearSitePermissionsButton.setOnClickListener {
            showConfirmationDialog(
                ...
                fr.thomas.erebus.web.SslErrorHandlerHelper.clearAllowedSslHosts()
                showSuccessDialog(
