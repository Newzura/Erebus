package fr.thomas.erebus.bookmarks
...
import fr.thomas.erebus.ui.adapters.BookmarkAdapter
        ...
        if (binding.bookmarkManagerList.adapter == null) {
            ...
            ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(ItemTouchHelper.UP or ItemTouchHelper.DOWN, 0) {
                override fun onMove(recyclerView: RecyclerView, viewHolder: RecyclerView.ViewHolder, target: RecyclerView.ViewHolder): Boolean {
                    bookmarkAdapter.onItemMove(viewHolder.adapterPosition, target.adapterPosition)
                    return true
                }
